...
namespace CajeroAutomatico.Persistance
{
    public class CajeroDBContext : DbContext
    {
        ...
        protected override void OnModelCreating(DbModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<DispensadorEfectivo>().HasOptional(v => v.ATM)
            ...
            modelBuilder.Entity<Pantalla>().HasOptional(v => v.ATM)
            ...
            modelBuilder.Entity<RanuraDeposito>().HasOptional(v => v.ATM)
            ...
            modelBuilder.Entity<Teclado>().HasOptional(v => v.ATM)
